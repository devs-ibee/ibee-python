...
class IbeeSolutions:
    ...
    def secret_store(self):
        if self._secret_store is None:
            from .secret_store.client import SecretStoreClient  # noqa: E402
    ...
    def cloud_vms(self):
        if self._cloud_vms is None:
            ...
            self._cloud_vms = CloudVmsClient(client_wrapper=self._client_wrapper)
        return self._cloud_vms

    @property
    def gpu_vms(self):
        if self._gpu_vms is None:
            from .gpu_vms.client import GpuVmsClient  # noqa: E402
...
class AsyncIbeeSolutions:
    ...
    def secret_store(self):
        if self._secret_store is None:
            from .secret_store.client import AsyncSecretStoreClient  # noqa: E402
    ...
    def cloud_vms(self):
        if self._cloud_vms is None:
            ...
            self._cloud_vms = AsyncCloudVmsClient(client_wrapper=self._client_wrapper)
        return self._cloud_vms

    @property
    def gpu_vms(self):
        if self._gpu_vms is None:
            from .gpu_vms.client import AsyncGpuVmsClient  # noqa: E402
